...
export default function Projects() {
	...
	const currentProjects = activeTab === "blockchain" ? blockchainProjects : webProjects;

	return (
		<section id="projects" className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-black/20 to-transparent">
			<div className="max-w-7xl mx-auto">
				{/* Section Header */}
				<div className="text-center mb-16">
					<div className="inline-block mb-4">
						<span className="text-lg text-cyan-400 font-mono tracking-wider opacity-80">&gt; const projects = await fetchMyWork();</span>
					</div>
								...
								<div className="flex items-start gap-3">
									...
									<div className="flex-1">
										...
										<p className="text-gray-300 text-sm leading-relaxed">
											Don't be fooled by the "fewer web projects" count! Each of my blockchain dApps required extensive{" "}
											<strong className="text-white">React/Next.js development</strong>,
											<strong className="text-white"> responsive UI design</strong>, and
											<strong className="text-white"> seamless UX</strong>. Building those beautiful interfaces that connect to
											smart contracts? That's pure web development wizardry! ⚡
										</p>
									</div>
								</div>
							</div>
							...
							<div className="h-full bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl overflow-hidden hover:bg-white/10 hover:border-white/20 transition-all duration-500 hover:transform hover:scale-105 hover:shadow-2xl hover:shadow-cyan-500/10">
								...
								<div className="p-6">
									...
									<div className="mb-6">
										...
										<ul className="space-y-1">
											...
											{project.features.length > 3 && (
												<li className="text-xs text-gray-500">+{project.features.length - 3} more features</li>
											)}
										</ul>
									</div>
									...
									<div className="flex gap-3 mt-auto">
										{project.title === "Labro.in" || project.title === "Samratai.com" || project.title === "Cesspit" ? (
											// Special buttons for Labro.in, Samratai.com, and Cesspit
											<button
