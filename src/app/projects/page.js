...
export default function AllProjectsPage() {
	...
	const blockchainProjects = [
		{
			title: "DeFiSalary 2.0",
			category: "Decentralized Payroll",
			description:
				"An enhanced and certified version of the DeFiSalary platform, reviewed and certified by the Alchemy team. This improved iteration features a more efficient architecture, faster performance, and lightweight design while maintaining all core functionalities. The platform automates salary payments using advanced smart contracts, with optimized employee management, streamlined payment tracking, and enhanced ChainLink automation for scheduled disbursements. Built with modern best practices for superior scalability and user experience.",
			technologies: ["Solidity", "Next.js", "Hardhat", "Ethers.js", "ChainLink", "Alchemy"],
			features: ["Alchemy Certified", "Optimized Architecture", "Enhanced Performance", "Advanced Automation"],
			status: "Live on Sepolia",
			image: "/projects/defiSalaryV2.png",
			demoUrl: "https://defisalary2.vercel.app/",
			githubUrl: "https://github.com/YashK-194/DefiSalary2.0",
			type: "blockchain",
			alchemyUrl: "https://university.alchemy.com/projects/defisalary-evm-chain-certificate",
		...
		},
		{
			...
			technologies: ["Solidity", "Next.js", "Hardhat", "Ethers.js", "ChainLink"],
			features: ["Automated Payments", "Employee Management", "Real-time Price Feeds", "Admin Dashboard"],
			status: "Live on Sepolia",
			...
			etherscanUrl: "https://sepolia.etherscan.io/address/0x205Ec9442384AC22eeAaA7C330937Af2fFfB8227",
		},
		{
			title: "NFT Warranty",
			...
			technologies: ["Solidity", "Next.js", "Hardhat", "Chai", "Hardhat Ignition"],
			features: ["NFT Warranties", "Smart Contract Verification", "Warranty Management", "Blockchain Security"],
			status: "Live on Sepolia",
			...
			etherscanUrl: "https://sepolia.etherscan.io/address/0xDdB2255528C6D3d8418968704C5B26590b75413B",
		},
		{
			title: "Pyth Price Feed Demo",
			category: "Oracle Integration",
			description:
				"A real-time price tracking demonstration application that integrates Pyth Network's oracle price feeds to monitor ETH/USD prices. The application fetches and logs cryptocurrency prices every second, displaying live price updates with visual indicators showing whether the price has increased or decreased from the previous reading. Built to explore and showcase Pyth Network's decentralized oracle capabilities for accurate, low-latency price data on the blockchain.",
			technologies: ["Pyth Network", "JavaScript", "Web3", "Oracle Integration", "Real-time Data"],
			features: ["Real-time Price Updates", "Price Change Indicators", "Second-by-Second Logging", "Pyth Oracle Integration"],
			status: "Demo",
			image: "/projects/pythPriceFeeds.png",
			demoUrl: "#",
			githubUrl: "https://github.com/YashK-194/Pyth-pricefeed-demo",
			type: "blockchain",
		...
		},
		{
			...
			technologies: ["Solidity", "Next.js", "Hardhat", "Chai", "IPFS", "Pinata"],
			features: ["Admin Controls", "IPFS Metadata Storage", "Automated Minting", "Network Detection"],
			status: "Live on Sepolia",
			...
			etherscanUrl: "https://sepolia.etherscan.io/address/0xa397d7e7C68C9b6aAC9A09F38F1F66c7CcE977b1",
		},
		{
			...
			technologies: ["Next.js", "React", "Solana Web3.js", "SPL Token", "Tailwind CSS"],
			features: ["Token Creation", "Token Minting", "Token Transfers", "Wallet Integration"],
		...
		},
		{
			...
			technologies: ["Solidity", "React.js", "Hardhat", "Ethers.js", "JavaScript"],
			features: ["Decentralized Listings", "Automated Lending", "Role-based Access", "Transparent Approvals"],
			status: "Live on Sepolia",
		...
		},
		{
			...
			technologies: ["Ever Solidity", "Locklift", "TypeScript", "Venom Blockchain", "TVM Compatible"],
			features: ["Smart Contract Deployment", "Multi-network Support", "Automated Testing", "TypeScript Integration"],
		...
		},
		{
			...
			technologies: ["Solidity", "React.js", "Hardhat", "Ethers.js", "MetaMask"],
			features: ["NFT Tickets", "Real-time Seat Selection", "Instant Payments", "Fraud Prevention"],
		...
		},
		{
			...
			technologies: ["React", "CSS3", "React Hooks", "JavaScript", "Hardhat", "Metamask"],
			features: ["Shopping Cart", "Purchasing Images With Eth via Metamask", "Real-time Price Calculation", "Purchase Tracking"],
			status: "Live on Sepolia",
		...
		},
		{
			...
			technologies: ["Solidity", "Hardhat", "JavaScript", "Hardhat Ignition", "Ganache"],
			features: ["Fund Contribution", "Smart Contract Testing", "Local Deployment", "Hardhat Integration"],
			status: "Live on Localhost",
		...
		},
		{
			...
			features: ["Token Storage", "Secure Transfers", "Canister Architecture", "Decentralized Infrastructure"],
			status: "Live on ICP",
		...
		},
		{
			...
			technologies: ["Solidity", "Ethers.js", "Hardhat", "JavaScript", "React.js"],
			features: ["Automated Winner Selection", "Secure Fund Management", "Provably Fair", "Transparent Results"],
		...
		},
		{
			...
			technologies: ["Solidity", "React.js", "Ethers.js", "Hardhat", "JavaScript"],
			features: ["ETH Donations", "Supporter Messages", "Donation Tracking", "Creator Withdrawals"],
			status: "Live on Localhost",
	...
	const webProjects = [
		{
			title: "Samratai.com",
			category: "Freelance - Educational Platform",
			description:
				"A professional portfolio and educational platform website built for Samrat Mukherjee, a renowned Data Science and Machine Learning instructor. The website showcases his expertise, courses, achievements, and teaching philosophy with a modern, responsive design. Features include course catalogs, instructor bio, testimonials, and contact forms, all optimized for performance and SEO to enhance his online presence and reach.",
			technologies: ["Next.js", "Tailwind CSS", "React.js", "Vercel", "Responsive Design"],
			features: ["Course Showcase", "Instructor Portfolio", "Responsive Design", "SEO Optimized"],
			status: "Live",
			image: "/projects/samratAi.png",
			demoUrl: "https://samratai.com",
			githubUrl: "#",
			type: "web",
			network: "Web Application",
		},
		{
			...
			technologies: ["Next.js", "Firebase", "Google Maps API", "React.js", "JavaScript"],
			features: ["Real-time Distance Calculation", "Location-based Service Discovery", "6+ Predefined Services", "Custom Service Listing"],
			status: "Live",
		...
		{
			title: "Cesspit",
			category: "Social Debate Platform",
			description:
				"A unique social platform designed specifically for structured debates and arguments. Users can create argument topics and engage in real-time discussions with a chat-like interface for comments, allowing them to argue either in support of or against any topic. The platform features an active user base, real-time comment threading, and an intuitive UI that encourages healthy debate and diverse perspectives. Built with modern web technologies to provide a seamless, engaging experience for users passionate about discussion and critical thinking.",
			technologies: ["Next.js", "React.js", "Firebase", "Tailwind CSS", "Real-time Database"],
			features: ["Argument Creation", "Support/Against Comments", "Real-time Chat Interface", "Active User Community"],
			status: "Live",
			image: "/projects/cesspit.png",
			demoUrl: "https://cesspit.vercel.app/",
			githubUrl: "https://github.com/YashK-194/cesspit",
			type: "web",
			network: "Web Application",
		},
		{
			...
			technologies: ["Next.js", "Firebase", "React.js", "Firestore", "Firebase Auth"],
			features: ["Project Investment Platform", "Social Networking Features", "Real-time Collaboration", "Investor Matching System"],
			status: "Live",
		...
		},
		{
			...
			features: ["Complete Shopping Cart", "Admin Dashboard", "Real-time Updates", "Advanced Search & Filtering"],
			status: "Live",
		...
		},
		{
			...
			technologies: ["Next.js", "React.js", "CSS3", "JavaScript", "Responsive Design"],
			features: ["Product Catalog", "Shopping Cart", "Product Details", "Responsive Design"],
			status: "Live",
		...
		},
		{
			...
			features: ["Admin-Only Movie Management", "Optimized Data Caching", "Automatic Title Formatting", "Efficient Movie Search"],
			status: "Live",
		...
		},
		{
			...
			technologies: ["Next.js", "React", "Material-UI", "Context API", "Custom Logging"],
			features: ["Bulk URL Shortening", "Custom Shortcodes", "Click Tracking", "Statistics Dashboard"],
			status: "Live",
		...
		{
			title: "Express.js MongoDB Practice",
			category: "Backend Development",
			description:
				"A comprehensive backend development learning project built with Express.js and MongoDB, focusing on RESTful API design and database operations. This project demonstrates fundamental backend programming concepts including CRUD operations, database schema design, API endpoint creation, and request/response handling. Features extensive API testing using Postman, MongoDB integration for data persistence, and Express.js routing for efficient request management. Built as a hands-on learning experience to master modern backend development practices.",
			technologies: ["Express.js", "MongoDB", "Node.js", "Postman", "REST API"],
			features: ["RESTful API Design", "CRUD Operations", "MongoDB Integration", "API Testing with Postman"],
			status: "Live",
			image: "/projects/expressJsMongoDb.png",
			demoUrl: "#",
			githubUrl: "https://github.com/YashK-194/expressjs-mongodb",
			type: "web",
			network: "Backend Application",
		},
	];
			...
			<nav className="fixed top-0 w-full z-50 bg-black/20 backdrop-blur-md border-b border-white/10">
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					<div className="flex justify-between items-center h-16">
						<Link href="/" className="text-xl font-bold bg-gradient-to-r from-cyan-400 to-pink-400 bg-clip-text text-transparent">
							← Back to Portfolio
						</Link>
					</div>
				</div>
				...
				<div className="max-w-7xl mx-auto">
					...
					<div className="text-center mb-16">
						...
						<p className="text-lg text-gray-300/80 max-w-3xl mx-auto mb-8">
							Explore my complete portfolio of blockchain innovations and modern web applications
						</p>

						{/* GitHub All Projects Button */}
						<div className="mb-8">
							<button
								onClick={() => window.open("https://github.com/YashK-194", "_blank")}
							...
							<div className="bg-gradient-to-r from-yellow-500/10 to-orange-500/10 backdrop-blur-md border border-yellow-400/20 rounded-2xl p-6">
								<div className="flex items-start gap-3">
									...
									<div className="flex-1">
										<h3 className="text-lg font-semibold text-yellow-400 mb-2">Pro Tip: Don't let the numbers fool you! 📊</h3>
										<p className="text-gray-300 text-sm leading-relaxed">
											While I might have fewer standalone web projects compared to blockchain ones, every single blockchain dApp
											you see here required extensive <strong className="text-white">frontend development</strong>,
											<strong className="text-white"> UI/UX design</strong>, and{" "}
											<strong className="text-white">web technologies</strong>. Building those sleek interfaces, responsive
											designs, and seamless user experiences? That's all web development magic! ✨ Each blockchain project is
											essentially a full-stack web app with smart contracts as the backend.
										</p>
									</div>
								</div>
							</div>
											...
											<div className="absolute top-4 right-4 z-10">
												<span
													className={`px-3 py-1 rounded-full text-xs font-medium backdrop-blur-md border ${
														project.status === "Live on Mainnet" || project.status === "Live"
